...
> A bit vague. Kind of seems like saying "I'm plotting the median to see the median in my plot" without explaining why you'd want to see the median in your plot.
...
> What has actually changed here? The plots look pretty much like the standard situation. If anything has been changed, it might be worth pointing out what you've changed in a comment.
...
> The plots should show a clear change at the time at which the event occurs. No such change can be observed in the plots produced by the code below.
