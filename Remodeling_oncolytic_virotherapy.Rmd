...
They are rather bodily constants, which were exposed to the effects of the diffrent viruses.
The amount of virus particles introduced to a system is a state variable, and remains the same for all virus
