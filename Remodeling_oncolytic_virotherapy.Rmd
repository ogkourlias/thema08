...
and plotted below. Gradual increases seem to also rapidly decrease the Ci and Hi.
...
by the plots in results. Many factors go intoensuring this competition between 
cells, viruses and immune system. Most of the important variables being 
controllable, like the specificity of the virus.

The destructive capability has also been observed. The models indicate that the
rate at which the virus reproduces, and lysates, is important. Changing this value
...
tend to vary in their replication and lysation rates.
