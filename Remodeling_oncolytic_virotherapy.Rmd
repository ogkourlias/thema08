...
the results differ significantly. These and all procceeding plots
...
The rate of infection of normal cells has been changed to 0 here.
Meaning that only tumor cells get infected and destroyed.

Further establishing that the competition 
...
by the plots in results. Many factors go into ensuring this competition between 
